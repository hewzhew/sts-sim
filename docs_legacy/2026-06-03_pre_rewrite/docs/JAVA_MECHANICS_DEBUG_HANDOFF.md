# Java Mechanics Debug Handoff

This is the long Java-mechanics debug handoff kept for source-backed parity
work. It is no longer the default resume file.

Default resumed sessions should read `docs/NEXT_AI_HANDOFF.md` first. Read this
file only when the chosen lane is Java-source-backed mechanics cleanup or when
the acceptance standard says a locked mechanism must be reopened.
...
This file is the durable working memory for Java mechanics parity/debug. If
`docs/NEXT_AI_HANDOFF.md` selects Lane B, read:
