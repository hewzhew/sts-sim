...
cargo run -p sts_oracle_tools --bin branch_panel -- panel smoke --seeds 1552225671 1552225672 1552225673 --capsule-root tools/artifacts/panels/current --max-branches 1 --slice-ms 60000
```
