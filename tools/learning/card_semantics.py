...
CARD_SEMANTICS: dict[str, dict[str, Any]] = {
    ...
    "Clothesline": _base_entry(card_type="attack", base_cost=2.0, base_damage=12.0, deals_damage=1.0, apply_weak=2.0, payoff_tag=1.0),
    "Uppercut": _base_entry(card_type="attack", base_cost=2.0, base_damage=13.0, deals_damage=1.0, apply_weak=1.0, apply_vulnerable=1.0, payoff_tag=1.0),
    "Feed": _base_entry(card_type="attack", base_cost=1.0, base_damage=10.0, deals_damage=1.0, payoff_tag=1.0),
    "Reaper": _base_entry(card_type="attack", base_cost=2.0, base_damage=4.0, deals_damage=1.0, multi_hit=1.0, payoff_tag=1.0),
    "Intimidate": _base_entry(card_type="skill", base_cost=0.0, apply_weak=1.0),
    "Disarm": _base_entry(card_type="skill", base_cost=1.0, apply_strength=-2.0, setup_tag=1.0),
    "Shockwave": _base_entry(card_type="skill", base_cost=2.0, apply_weak=3.0, apply_vulnerable=3.0, apply_frail=3.0, setup_tag=1.0),
    ...
    "Flame Barrier": _base_entry(card_type="skill", base_cost=2.0, base_block=12.0, grants_block=1.0),
    ...
    "Offering": _base_entry(card_type="skill", base_cost=0.0, draw_count=3.0, card_draw_engine=1.0, setup_tag=1.0),
    "Limit Break": _base_entry(card_type="skill", base_cost=1.0, apply_strength=1.0, setup_tag=1.0, payoff_tag=1.0),
    ...
    "Demon Form": _base_entry(card_type="power", base_cost=3.0, apply_strength=2.0, setup_tag=1.0),
    "Barricade": _base_entry(card_type="power", base_cost=3.0, block_tag=1.0, setup_tag=1.0),
