...
- [CAMPAIGN_SYSTEM_ARCHITECTURE.md](CAMPAIGN_SYSTEM_ARCHITECTURE.md)
- [CAMPAIGN_CLI_CONTRACT.md](CAMPAIGN_CLI_CONTRACT.md)
- [CAMPAIGN_MIGRATION_PLAN.md](CAMPAIGN_MIGRATION_PLAN.md)
