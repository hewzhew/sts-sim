...
- [PROTOCOL_TRUTH_RULES.md](/d:/rust/sts_simulator/docs/protocol/PROTOCOL_TRUTH_RULES.md:1)
- [GUARDIAN_THRESHOLD_TEST_MATRIX.md](/d:/rust/sts_simulator/docs/protocol/GUARDIAN_THRESHOLD_TEST_MATRIX.md:1)
