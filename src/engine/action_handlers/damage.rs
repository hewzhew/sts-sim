...
use core::{
    ...
    clear_post_combat_actions_if_ready, queue_on_block_gained_hooks, queue_player_hp_loss_hooks,
    queue_red_skull_threshold_actions, should_cancel_java_damage_action,
    target_receives_java_unique_kill_reward, update_player_cards_on_damage,
};
