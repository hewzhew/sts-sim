...
pub use rank_adjustment::{
    branch_retention_adjusted_rank_key_v1, branch_retention_order_rank_key_v1,
    branch_retention_rank_adjustment_v1,
};
...
pub(super) fn branch_retention_slot_evidence_scores_v1(
    candidate: &BranchRetentionCandidateInputV1,
...
pub(super) fn current_startup_debt_rank_adjustment_v1(
    candidate: &BranchRetentionCandidateInputV1,
) -> i32 {
...
mod tests {
    ...
    use crate::eval::branch_experiment::BRANCH_EXPERIMENT_CARD_REWARD_STRATEGIC_TRACE_SIGNAL_SOURCE_V1;
