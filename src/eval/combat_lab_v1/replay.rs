    ...
    ) -> Result<CombatSearchV2WitnessReplayV1, String>,
{
    ...
    CombatLabCellRecordV1 {
        ...
        initial_state_fingerprint: sample.state_fingerprint.clone(),
        non_shuffle_rng_hash: sample.non_shuffle_rng_hash.clone(),
        shuffle_rng_hash: sample.shuffle_rng_hash.clone(),
