...
pub(crate) struct SearchPerformanceReview {
    ...
    pub(crate) turn_boundary_macro_calls: u64,
    pub(crate) turn_boundary_macro_candidates: u64,
    pub(crate) turn_boundary_macro_inner_nodes_expanded: u64,
    pub(crate) turn_boundary_macro_inner_nodes_generated: u64,
    pub(crate) turn_boundary_macro_exact_state_skips: u64,
    pub(crate) turn_boundary_macro_atomic_fallbacks: u64,
    pub(crate) turn_boundary_macro_us: u128,
