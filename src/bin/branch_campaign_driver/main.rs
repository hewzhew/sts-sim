...
// Internal compatibility shape used by the existing campaign handlers. The
// top-level parser still exposes this for old commands, but subcommands should
// convert into it through the command-specific structs above.
