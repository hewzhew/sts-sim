...
use sts_simulator::eval::run_control::{
    build_decision_surface, RewardAutomationConfig, RunControlAutoAppliedKindV1,
    RunControlAutoAppliedStepV1, RunControlAutoStepOptions, RunControlAutoStopKind,
    RunControlAutoStopV1, RunControlCommand, RunControlConfig, RunControlHpLossLimit,
...
fn require_visible_input(
    ...
    Err(format!(
        ...
        owners::executable_choices_including_cancel(&surface)
            .iter()
