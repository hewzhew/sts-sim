...
fn stable_nemesis_signature(state: &NemesisRuntimeState) -> String {
    format!(
...
fn stable_exploder_signature(state: &ExploderRuntimeState) -> String {
    format!("seed{}:turn{}", state.protocol_seeded, state.turn_count)
}

fn stable_maw_signature(state: &MawRuntimeState) -> String {
    format!(
        "seed{}:roared{}:turn{}",
...
fn stable_sentry_signature(state: &SentryRuntimeState) -> String {
    format!("seed{}:first{}", state.protocol_seeded, state.first_move)
}

fn stable_slime_boss_signature(state: &SlimeBossRuntimeState) -> String {
    format!("seed{}:first{}", state.protocol_seeded, state.first_turn)
}

fn stable_large_slime_signature(state: &LargeSlimeRuntimeState) -> String {
    format!(
        "seed{}:split{}",
