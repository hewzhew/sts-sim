...
fn divergence_rank(kind: StateDivergenceKind) -> u8 {
    match kind {
        ...
        StateDivergenceKind::MonsterRuntimeDelta => 10,
        StateDivergenceKind::CombatRuntimeHintDelta => 11,
        StateDivergenceKind::PotionStateDelta => 12,
        StateDivergenceKind::RelicCounterDelta => 13,
        StateDivergenceKind::PlayerFutureDelta => 14,
        StateDivergenceKind::ZoneRuntimeDelta => 15,
        StateDivergenceKind::EngineRuntimeDelta => 16,
        StateDivergenceKind::CombatMetaDelta => 17,
        StateDivergenceKind::PendingQueueDelta => 18,
        StateDivergenceKind::IdentityOnlyCandidate => 19,
        StateDivergenceKind::Unknown => 20,
    }
}
