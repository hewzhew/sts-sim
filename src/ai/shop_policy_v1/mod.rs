...
pub use types::{
    ...
    ShopPlanExecutionApprovalV1, ShopPlanExecutionStatusV1, ShopPlanFrontierV1, ShopPlanKindV1,
    ShopPlanLaneGroupV1, ShopPlanLaneV1, ShopPlanProjectionRoleV1, ShopPlanProjectionV1,
