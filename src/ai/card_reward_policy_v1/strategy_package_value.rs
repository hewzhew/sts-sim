...
use super::strategy_package_threat_alignment::{
    strategy_package_threat_alignment_bonus, strategy_package_threat_alignment_components,
};
use super::types::{
...
pub(super) fn package_would_be_completed(
    context: &CardRewardDecisionContextV1,
    candidate: &super::types::CardRewardCandidateEvidenceV1,
    package_id: StrategyPackageIdV2,
) -> bool {
