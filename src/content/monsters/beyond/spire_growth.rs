...
impl MonsterBehavior for SpireGrowth {
    fn roll_move(_rng: &mut crate::rng::StsRng, entity: &crate::combat::MonsterEntity, ascension_level: u8, num: i32) -> (u8, Intent) {
        ...
        let last_two_moves_1 = entity.move_history.len() >= 2 && entity.move_history[entity.move_history.len()-1] == 1 && entity.move_history[entity.move_history.len()-2] == 1;
        let last_two_moves_3 = entity.move_history.len() >= 2 && entity.move_history[entity.move_history.len()-1] == 3 && entity.move_history[entity.move_history.len()-2] == 3;
        ...
        if num < 50 && !last_two_moves_1 {
            return (1, Intent::Attack { damage: tackle_dmg, hits: 1 });
        }
        ...
        if !last_two_moves_3 {
            return (3, Intent::Attack { damage: smash_dmg, hits: 1 });
        }

        (1, Intent::Attack { damage: tackle_dmg, hits: 1 })
    }
