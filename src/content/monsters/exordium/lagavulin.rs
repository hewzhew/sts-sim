...
impl MonsterBehavior for Lagavulin {
    ...
    fn take_turn(state: &mut CombatState, entity: &MonsterEntity) -> Vec<Action> {
        ...
        match entity.next_move_byte {
            ...
            5 => { // SLEEP
                ...
                if idle_count >= 3 {
                    actions.push(Action::RemovePower { target: entity.id, power_id: PowerId::Metallicize });
    ...
    fn on_damaged(_state: &mut CombatState, entity: &MonsterEntity, actual_lost: i32) -> smallvec::SmallVec<[crate::action::ActionInfo; 4]> {
        if actual_lost > 0 && entity.current_intent == Intent::Sleep {
            smallvec::smallvec![
                ...
                crate::action::ActionInfo {
                    action: Action::RemovePower { target: entity.id, power_id: PowerId::Metallicize },
