    ...
    match event_state.current_screen {
        0 => {
            ...
            if run_state.gold >= COST_1 {
                choices.push(EventChoiceMeta::new(format!("[1 Potion] Lose {} Gold.", COST_1)));
            } else {
                choices.push(EventChoiceMeta::disabled(format!("[1 Potion] {} Gold.", COST_1), "Not enough Gold"));
            }
            if run_state.gold >= COST_2 {
                choices.push(EventChoiceMeta::new(format!("[2 Potions] Lose {} Gold.", COST_2)));
            } else {
                choices.push(EventChoiceMeta::disabled(format!("[2 Potions] {} Gold.", COST_2), "Not enough Gold"));
            }
            if run_state.gold >= COST_3 {
                choices.push(EventChoiceMeta::new(format!("[3 Potions] Lose {} Gold.", COST_3)));
            } else {
                choices.push(EventChoiceMeta::disabled(format!("[3 Potions] {} Gold.", COST_3), "Not enough Gold"));
            }
