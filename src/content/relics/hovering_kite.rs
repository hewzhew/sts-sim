...
pub fn at_turn_start(relic_state: &mut crate::content::relics::RelicState) -> SmallVec<[ActionInfo; 4]> {
    relic_state.used_up = false;
    SmallVec::new()
}

pub fn on_discard(_state: &CombatState, relic_state: &mut crate::content::relics::RelicState) -> SmallVec<[ActionInfo; 4]> {
