...
impl CardStructure {
    ...
    const EXHAUST_RECOVERY: u32 = 1 << 12;
    const DISCARD_CYCLE: u32 = 1 << 13;
    const VULN_PAYOFF: u32 = 1 << 14;
    const SELF_DAMAGE_PAYOFF: u32 = 1 << 15;
    const BLOCK_PAYOFF: u32 = 1 << 16;
    const DISCARD_RETRIEVAL: u32 = 1 << 17;
...
pub(crate) const fn structure(card_id: CardId) -> CardStructure {
    ...
    let bits = match card_id {
        ...
        Rupture => S::STRENGTH_ENABLER | S::SETUP_PIECE | S::SCALING_PIECE | S::SELF_DAMAGE_PAYOFF,
